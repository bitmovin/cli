...
export default class PlayerAnalyticsActivate extends BaseCommand {
    ...
    static args: {
        licenseId: import("@oclif/core/interfaces").Arg<string, Record<string, unknown>>;
    };
    static flags: {
        'analytics-key': import("@oclif/core/interfaces").OptionFlag<string, import("@oclif/core/interfaces").CustomOptions>;
